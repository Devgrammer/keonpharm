        ...
        <main className={`font-sans text-gray-800 bg-white p-4 space-y-2`}>
          ...
          <SectionWrapper id="we_are" subHead="">
            ...
            <p className="max-w-8xl text-md mx-auto leading-relaxed text-justify text-gray-700">
              ...
              tradition and innovation. From Varanasi — India’s spiritual
              capital — we are redefining healthcare by blending advanced
              pharmaceutical research with the wisdom of Ayurveda and the power
              of natural plant-based substances. Our mission: to deliver
              holistic, evidence-based solutions that honor both ancient
...
Ex-President of Mycology Society of India"
          ...
          <SectionWrapper id="promise" subHead="">
            ...
            <div className="promise-content text-justify md:text-center mb-8">
              At Keon Pharm, we don’t just make medicines—we craft trust,
              wellness, and hope. Our commitment to excellence, ethics, and
              innovation sets us apart. Choosing Keon Pharm means joining a
              community driven by purpose and compassion.
            </div>
